            ...
            tasks.forEach(task => {
                ...
                html += `
                    <tr>
                        ...
                        <td>
                            <div class="dropdown">
                                <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton${task.id}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    操作
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton${task.id}">
                                    <a class="dropdown-item" href="#" onclick="runTask(${task.id})"><i class="fas fa-play"></i> 执行</a>
